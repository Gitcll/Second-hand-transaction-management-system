...
public interface GoodMapper {
	...
	@Insert("insert into good_table (name, photo_url, first_type_id, second_type_id, prise, description, user_id, status_id, upload_date, update_time) "
	...
	@Update("UPDATE good_table SET name = #{name}, first_type_id = #{firstTypeId}, second_type_id = #{secondTypeId}, prise = #{prise}, description = #{describe} WHERE id = #{id};")
